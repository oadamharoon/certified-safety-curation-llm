...
# safevlmcpl env) -> smoke test -> 18 LoRA runs (certcurate-llm env) -> generation -> judging.
...
S=/tmp/claude-1001/-home-omniverse-workspace-safevlmcpl/cbe3ff25-bd02-4cf4-9f36-173bf5fa270c/scratchpad/e3smoke
